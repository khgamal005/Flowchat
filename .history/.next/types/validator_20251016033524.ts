...
// Validate ../../src/app/api/web-socket/messages/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/web-socket/messages">> = Specific
  const handler = {} as typeof import("../../src/app/api/web-socket/messages/route.js)
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../src/pages/api/web-socket/io.ts
{
  type __IsExpected<Specific extends ApiRouteConfig> = Specific
  const handler = {} as typeof import("../../src/pages/api/web-socket/io.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
