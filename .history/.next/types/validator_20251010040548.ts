...
// Validate ../../src/app/(authentication)/login/page.tsx
{
  ...
  const handler = {} as typeof import("../../src/app/(authentication)/auth/page.jsx")
...
// Validate ../../src/app/(authentication)/login/callback/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/login/callback">> = Specific
...
// Validate ../../src/app/(authentication)/login/confirm/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/login/confirm">> = Specific
