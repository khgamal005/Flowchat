...
const Workspace = async (props: {
  ...
  return (
    <>
      ...
      <Sidebar
        currentWorkspaceData={currentWorkspaceData} // Now guaranteed to be a Workspace object
        userData={userData}
        // Note: The correct prop name in your sidebar component is 'userWorkspacesData'
        // based on your Sidebar component code, not 'userWorksapcesData'.
        // I've kept the original incorrect spelling as is, but you should fix it in both places.
