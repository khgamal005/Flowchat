  ...
  return (
    <div className="p-1 border dark:border-zinc-500 border-neutral-700 rounded-md relative overflow-hidden">
      ...
      <div className="h-[150px] pt-11 flex w-full grow-1">
       <EditorContent
  className="prose w-full h-[150px] p-2 dark:text-white leading-normal overflow-y-auto whitespace-pre-wrap"
  editor={editor}
/>

      </div>

      {/* Plus Icon - Opens File Upload */}
      <div
      ...
      <Dialog open={fileUploadModal} onOpenChange={setFileUploadModal}>
        <DialogContent className="sm:max-w-md" forceMount>
          ...
          {/* File Upload Component (stays mounted) */}
          <ChatFileUpload
            userData={userData}
