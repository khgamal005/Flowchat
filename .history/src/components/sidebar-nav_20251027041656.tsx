...
console.log('SidebarNav currentWorkspaceData',currentWorkspaceData);
        ...
        <li>
          <Popover>
            <PopoverTrigger asChild>
              {/* Single child element - the Avatar */}
              <Avatar className='w-10 h-10 border-0 bg-transparent p-0 cursor-pointer'>
                <AvatarImage
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div className='flex items-center gap-x-2'>
                              ...
                              <Copy
                                onClick={e => {
                                  e.stopPropagation(); // Prevent triggering workspace switch
