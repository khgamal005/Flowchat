...
const ChatMessages: FC<ChatMessagesProps> = ({
  ...
  // ✅ Properly destructure the socket hook
  const { socket, isConnected, socketId } = useSocket();

  // ✅ Debug socket connection
  useEffect(() => {
    console.log("🔌 Socket connection status:", { isConnected, socketId, socket: !!socket });
  }, [isConnected, socketId, socket]);
  ...
  useEffect(() => {
    ...
    const handleMessage = (msg: any) => {
      ...
      // You might want to update your local state or trigger a refetch
    };
  ...
  // ✅ Use the chat socket connection hook with proper socket handling
  const { isConnected: chatConnected } = useChatSocketConnection({
    queryKey,
  ...
  // ✅ Connection status display for debugging
