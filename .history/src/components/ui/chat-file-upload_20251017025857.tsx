...
import { createClient, getSupabaseClient } from '@/supabase/supabaseClient'; // ✅ use client-side Supabase
...
// ✅ fixed schema: works correctly with React Hook Form file inputs
...
const ChatFileUpload: FC<ChatFileUploadProps> = ({
  ...
  async function handleUpload(values: z.infer<typeof formSchema>) {
    ...
    console.log('File object:', values.file?.[0]);
