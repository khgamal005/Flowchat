...
type SidebarProps = {
  userWorkspacesData: Workspace[]; // ✅ consistent spelling
...
const Sidebar: FC<SidebarProps> = ({
  ...
  console.log("userData in Sidebar:", userData ,currentWorkspaceData); // Debugging line
                    ...
                    <div>
                      ...
                      <div className="flex flex-col space-y-1">
                        ...
                        <Typography
                          variant="p"
                          text={`Sign out of ${
                            currentWorkspaceData?.name || "current workspace"
                          }`}
                          className="hover:text-white hover:bg-blue-700 px-2 py-1 rounded cursor-pointer"
                        />
                      </div>
