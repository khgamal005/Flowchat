      ...
      <ul className='flex flex-col space-y-4'>
        <li>
          <div className='cursor-pointer items-center text-white mb-4 w-10 h-10 rounded-lg overflow-hidden'>
            <Popover>
              <PopoverTrigger asChild> {/* Add asChild here */}
                <div className='cursor-pointer w-10 h-10'> {/* Use div instead of button */}
                  <Avatar>
                    <AvatarImage
              ...
              <PopoverContent className='p-0' side='bottom'>
                <Card className='w-[350px] border-0'>
                  <CardContent className='flex p-0 flex-col'>
                    ...
                    <Separator />
                    {/* CreateWorkspace should not contain any nested button issues */}
                    <CreateWorkspace />
                  </CardContent>
                </Card>
              </PopoverContent>
